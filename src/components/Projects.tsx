...
import { ActAwareDiagram, ActAwareFlow, EmailAgentDiagram, EmailAgentFlow, OrbitDeskDiagram, OrbitDeskFlow } from './diagrams'
  ...
  return (
    <section id="projects" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
      <SectionHeading
        ...
        description="Each of these shipped as a working system inside a hackathon or assignment window — not just a proposal. Open one for the full case study."
      />
